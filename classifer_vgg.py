...
image_bbox_df = pd.read_csv('/data/krf/model/rsna/image_bbox_full.csv')
...
sub_img_df = pd.DataFrame({'path': 
              glob('/data/krf/dataset/stage_1_test_images/*.dcm')})
...
pred_avg_df[['patientId', 'PredictionString']].to_csv('submission_vgg.csv', index=False)
